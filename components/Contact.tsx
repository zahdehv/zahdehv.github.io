  ...
  return (
    <Section id="contact" title="Get In Touch">
      <div className="text-center max-w-xl mx-auto">
        ...
        <a
          href={`mailto:${email}`}
          className="inline-block bg-sky-500 text-white font-bold text-lg px-8 py-4 rounded-lg shadow-lg hover:bg-sky-600 transition-all duration-300 transform hover:scale-105 mb-12"
        >
          Say Hello
        </a>
